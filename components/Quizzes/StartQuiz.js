...
import { primary, secondary, secondaryText, primaryText, primaryDark, primaryLight, } from "../../utils/colors";
...
class StartQuiz extends Component {
    ...
    render() {
        const { deck, numberOfQuestions, currentQuestion, showAnswer, opacity, width,height } = this.state


        return <View style={styles.container}>

            {numberOfQuestions === 0 &&
                (<Text>at least add one card</Text>)
            }
